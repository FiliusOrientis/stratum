...
| `feat/pdf-worker`    | Active | PDF worker for metadata, page count, and thumbnail                    |
| `chore/full-cleanup` | Active | Repo-wide code cleanup: import pipeline, React usage, structure, docs |
