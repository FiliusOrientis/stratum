...
- **pnpm overrides**: root `pnpm.overrides` pins `nanoid` ≥3.3.17 (GHSA-2v37-7h3g-55p8) — postcss declares `^3.3.16` which resolves to a vulnerable build. Remove the override once postcss/vite ship a patched range.
